...
public interface TaskUserRepository extends JpaRepository<Assignment, Long> {
    ...
    @Query(nativeQuery = true, value = "select tu.task_id as taskId, a.taskName as taskName, tu.assign_by_id as assignById, u.username as assignByName from task_user tu " +
    ...
    @Modifying
    @Query(nativeQuery = true, value = "INSERT INTO task_user (task_id, assign_by_id) VALUES (?1, ?2)")
